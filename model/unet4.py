...
class HAPFSR(nn.Module):
    ...
    def forward(self, x):
        ...
        sr_feature = self.SR_up2(sr_feature)+ F.interpolate(feature, scale_factor=2, mode='bicubic')
        ...
        sr_feature = self.SR_up3(sr_feature)+ F.interpolate(feature, scale_factor=4, mode='bicubic')
